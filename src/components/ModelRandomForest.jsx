    ...
    <div className="flex flex-wrap justify-between pt-20 sm:pl-20 sm:-m-6">
      ...
      <div className="relative z-10 w-full lg:w-5/12 xl:w-1/2 p-6 sm:-mt-10">
        ...
        <div className="max-w-lg text-gray-100 mb-9 sm:text-lg opacity-60">
          <ol>
            <li>
              1. Initializes a Random Forest Regressor model object named rf_model with a random state set to 42.
              "RandomForestRegressor" is a class from the scikit-learn library used for regression tasks.
            </li>
            <li>
              2. Trains the Random Forest model ("rf_model") using the training data "X_train" and the corresponding
              target values "y_train".
            </li>
            <li>
              3. Predicts the target values for the test data "X_test" using the trained Random Forest model.
              The predicted values are stored in the variable "y_pred_rf".
            </li>
            <li>
              4. Calculates the score of the Random Forest model on the test data. The "score" method in
              scikit-learn calculates the coefficient of determination R^2 of the prediction.
              R^2 is a measure of how well the predictions match the actual values. The
              calculated score is stored in the variable "score_rf".
            </li>
          </ol>
          <p>
            The purpose of this code is to initialize, train, and evaluate a Random Forest Regressor model.
            It then uses the trained model to make predictions on unseen test data and calculates the model's
